...
{
    public class ResumableUploadStrategy : IUploadStrategy
    {
        private readonly IStorageProviderFactory _providerFactory;

        public ResumableUploadStrategy(IStorageProviderFactory providerFactory)
        {
            _providerFactory = providerFactory;
        }

        public string StrategyName => "Resumable";
